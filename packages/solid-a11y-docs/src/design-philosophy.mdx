...
[Tailwind CSS][tailwindcss], but this is a not necessitated choice.

Additionally, `solid-a11y` has _zero_ NPM dependencies, if you don't count its peer dependency on
Solid, and should be tree-shakeable so that one only pays in bundle bytes for the components they
use.
...
All code, including this documentation website, is licened under the permissive MIT. See `LICENSE`
in the source code.
